...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('➕ Add Me To Your Groups ➕', url='https://t.me/THEMOVIEFILESPROBOT?startgroup=true')
            ],[
            InlineKeyboardButton('🔍 Search Here', switch_inline_query_current_chat=''),
            InlineKeyboardButton('🕵 Go Inline', switch_inline_query='')
            ],[
            InlineKeyboardButton('⭕ Support ⭕', url='https://t.me/lunasupportz'),
            InlineKeyboardButton('⭕ Updates ⭕', url='https://t.me/+gpX3sKd29WJjMmY9')
            ],[
        ...
        buttons= [[
            InlineKeyboardButton('⭕ Updates ⭕', url='https://t.me/+gpX3sKd29WJjMmY9'),
            InlineKeyboardButton('⭕ Support ⭕', url='https://t.me/Missharelyluna_bot')
            ],[
            InlineKeyboardButton('🚸 Powered By', url='https://t.me/lunasupportz'),
